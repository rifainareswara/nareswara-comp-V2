                ...
                @forelse ($teams as $team)
                    <div
                        ...
                        <div class="flex flex-col gap-1 text-center">
                            <p name="name" class="font-bold text-xl leading-[30px]">{{ $team->name }}</p>
                            <p name="occupation" class="text-cp-light-grey">{{ $team->occupation }}</p>
                        </div>
    ...
    <div id="Stats" class="bg-cp-black w-full mt-20 relative z-1-">
        <div class="container max-w-[1000px] mx-auto py-10">
            <div class="flex flex-wrap items-center justify-between p-[10px]">
                ...
                @empty
                    <p>belum ada data statistic terbaru!</p>
                @endforelse
            </div>
        </div>
    </div>
