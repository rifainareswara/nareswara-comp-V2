            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{ route('admin.principles.update', $principle) }}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ Storage::url($principle->thumnail) }}" alt="" class="rounded-2xl object-cover w-[90px] h-[90px]">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="subtitle" id="subtitle" cols="30" rows="5" value="{{ $principle->subtitle }}" class="border border-slate-300 rounded-xl w-full"> </textarea>
